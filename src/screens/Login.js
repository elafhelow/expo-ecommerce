...
<Text style={ {fontSize: 40,
    ...
    color: 'white',
    position: 'absolute',
    marginTop: 120,}}>Makeup Store</Text>
  ...
  {errorMessage.email && <Text style={styles.errorMessage}>{errorMessage.email}</Text>}
  ...
  >
    ...
    marginLeft: 100,
            ...
            <TouchableOpacity
              style={{marginRight: 80}}onPress={() => props.navigation.navigate('Signup')}>
              <Text style={{fontSize: 15,marginRight:70,marginTop: 15,fontWeight: 'bold',color:'#3AA3D4'}}>Signup</Text>
            </TouchableOpacity>
          </View>
        </View>
        </View>
