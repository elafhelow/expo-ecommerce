...
const ProductDetails = ({ navigation, route }) => {
  ...
  return (
    <ScrollView>
      <ImageBackground source={item.images} style={{ height: 400 }}>
        <StatusBar
          animated={true}
          backgroundColor="red"
          barStyle="default"
        ...
        <View style={styles.row}>
          <TouchableOpacity activeOpacity={0.6} style={styles.heart}>
            <Ionicons color={"black"} name={"heart-outline"} size={24} />
          </TouchableOpacity>
          <TouchableOpacity activeOpacity={0.6} style={styles.bag}>
      ...
      <View style={styles.row}>
        <View style={styles.Rate}>
          ...
          <Text style={{ marginStart: 10, fontSize: 16, marginBottom: 4 }}>
            4.3
          </Text>
        </View>
      </View>
      ...
      <View style={styles.row}>
        ...
        <View style={styles.Quantityrow}>
          <TouchableOpacity style={styles.minus} onPress={decreaseCounter}>
          ...
          <TouchableOpacity style={styles.plus} onPress={increaseCounter}>
